...
- **Fail-closed on ambiguity** — On payment-outcome ambiguity, the reservation is *held*, never released speculatively. Fail-closed means "keep tokens locked until we know" — a background resolver eventually breaks the tie by reading the Lightning node's authoritative state.
